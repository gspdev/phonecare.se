...
class Dylan_Repairdevice_Model_Mysql4_Repairaddress_Collection extends Mage_Core_Model_Mysql4_Collection_Abstract
{
 	public function _construct()
    {
        parent::_construct();
        $this->_init('repairdevice/repairaddress');
	}

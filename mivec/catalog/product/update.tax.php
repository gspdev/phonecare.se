...
define("__ATTR_PRODUCT_TAX__" , 121);
define("__ATTR_PRODUCT_TAX_TWO__" , 2);
define("__ATTR_PRODUCT_TAX_ONE__" , 0);
...
$sql = "SELECT a.entity_id,a.sku,b.`value` as status,b.attribute_id FROM "
    ...
    ." WHERE b.attribute_id=".__ATTR_PRODUCT_TAX__
...
{
    global $db;
    $sql = "UPDATE " . __TABLE_PRODUCT_INT__ . " SET `value`=" . __ATTR_PRODUCT_TAX_TWO__
        ." WHERE entity_id=" . $_entityId." AND attribute_id =121";
    return $db->query($sql);
}
